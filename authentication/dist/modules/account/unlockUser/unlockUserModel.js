...
var UnlockUserModel = /** @class */ (function () {
    function UnlockUserModel(messagingAdapter) {
        this.messagingAdapter = messagingAdapter;
    }
    UnlockUserModel.prototype.execute = function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!user.blocked) return [3 /*break*/, 3];
    ...
    UnlockUserModel.prototype.update = function (_a) {
        var username = _a.username;
        return __awaiter(this, void 0, void 0, function () {
            var updateUser;
            return __generator(this, function (_b) {
