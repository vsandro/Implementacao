...
var UnlockUserController = /** @class */ (function () {
    ...
    UnlockUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var username, kafkaMessagingAdapter, unlockUserModel, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, unlockUserModel.update({
                                username: username
                            })];
                    case 2:
                        _a.sent();
